> [기술 블로그](https://jjjlyn.netlify.app)로 이전하였습니다. 최신 업데이트된 문서는 블로그에서 확인하실 수 있습니다.
...
- 자세한 내용은 [이 곳](https://github.com/jjjlyn/resume/blob/main/infra/overall-architecture.md)에서 확인하실 수 있습니다.
- 운영 환경 관리
- 개발 환경 구축
